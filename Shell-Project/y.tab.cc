...
{
       0,    61,    61,    65,    66,    70,    74,    78,    81,    86,
      93,    94,    98,   115,   123,   124,   128,   132,   138,   145,
     151,   155,   162,   163,   167,   171
};
#endif
...
static const char *const yytname[] =
{
  ...
  "PIPE", "LESS", "AMPERSAND", "GREATAND", "GREATGREAT", "TWOGREAT",
  "GREATGREATAND", "$accept", "goal", "commands", "command",
...
#line 132 "shell.y" /* yacc.c:1646  */
    ...
    Shell::_currentCommand.redirect(1, (yyvsp[0].cpp_string));
    Shell::_currentCommand.redirect(2, new std::string((yyvsp[0].cpp_string)->c_str()));
